...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-kp-2.16-kirby-problem-2.16-40a80154-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/KP-2.16"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-kp-2.16-kirby-problem-2.16-40a80154-v1",
      "problem_contract_sha256": "14b6e0f2e5faaa63ea52e5b1391e2e6edfca9af8063f2942adf22dafb9c4263d",
      "problem_id": "problem:um-kp-2.16-kirby-problem-2.16-40a80154",
      "route_id": "route:um-kp-2.16-kirby-problem-2.16-40a80154-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-kp-2.16-kirby-problem-2.16-40a80154-source-fidelity-01",
      "graph_id": "graph:um-kp-2.16-kirby-problem-2.16-40a80154-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-kp-2.16-kirby-problem-2.16-40a80154-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-kp-2.16-kirby-problem-2.16-40a80154-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "If two hyperbolic surfaces have the same unmarked simple length spectra (i.e., the same multiset of lengths that correspond to simple closed curves), are they isometric?"
          },
          "statement_sha256": "87dec7dfca379bb313d361409dbf8c537e662873199cc2091226084db5eb3e6c"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-kp-2.16-kirby-problem-2.16-40a80154-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-kp-2.16-kirby-problem-2.16-40a80154-root",
      "route_id": "route:um-kp-2.16-kirby-problem-2.16-40a80154-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-kp-2.16-ba789e3119f8",
        "url": "https://www.unsolvedmath.com/problems/KP-2.16"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
